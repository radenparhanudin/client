<head>
   ...
   <link rel="stylesheet" href="{{ asset('startmin/css/bs4.css') }}">
   <!-- MetisMenu CSS -->
   ...
   <link rel="stylesheet" href="{{ asset('startmin/plugins/select2/dist/css/select2.min.css') }}">
   <link rel="stylesheet" href="{{ asset('startmin/plugins/toastr/toastr.min.css') }}">
